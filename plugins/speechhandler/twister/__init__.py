...
class MySpeechHandler(plugin.SpeechHandlerPlugin):
    ...
    def handle(self, intent, mic):
        ...
        mic.say("OK, let's play Twister")

        # TODO: disable the ambient plugin...? or should the ambient plugin disable itself when other plugins are active? 
        # TODO: start a loop
        # TODO: randomly select a colour and a hand/foot
        # TODO: say the instruction
        # TODO: respond to "game over" to quit the loop
